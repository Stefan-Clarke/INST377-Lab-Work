document.addEventListener('DOMContentLoaded', () => {
    ...
    //randomly select a tetris for its first rotation
    ...
    function undraw() {
        current.forEach(index => {
            squares[currentPosition + index].classList.remove('tetriomino')
    ...
    function displayShape() {
        ...
        upNextTetrominoes[nextRandom].forEach(index => {
            ...
            displaySquares[displayIndex + index].getElementsByClassName.backgroundColor = colors[nextRandom]
        })
    }
        ...
        for (let i = 0; i < 199; i += width) {
            ...
            if (row.every(index => squares[index].classList.contains('taken'))) {
                ...
                row.forEach(index => {
                    ...
                    squares[index].getElementsByClassName.backgroundColor = ''
                })
